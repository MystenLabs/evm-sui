...
The full design narrative — which IPFS quote each fruit addresses, the shape of each migration, the recommended sequencing — lives in [`walrus-low-hanging-fruits.html`](./walrus-low-hanging-fruits.html). The 2026 builder-sentiment survey it was distilled from is [`ipfs-pain.md`](./ipfs-pain.md).
